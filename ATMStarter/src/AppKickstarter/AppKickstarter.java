...
public abstract class AppKickstarter {
    ...
    public AppKickstarter(String id, String cfgFName) {
        ...
        // here calls the private constructor of AppKickstarter
    } // AppKickstarter
     ...
     * @param id       name of the application
     * @param cfgFName file name of the configuration file
     * @param append   appending or overwriting log file? default set as false
     */
    private AppKickstarter(String id, String cfgFName, boolean append) {
        ...
        // get the class name of the object on runtime
        id = getClass().getName();
    ...
    public void regThread(AppThread appThread) {
        ...
        synchronized (appThreads) {
            // appThreads is a hash table
            // here is to put the corresponding appThread into the hash table of this appkickstarter
